...
class Cart {
	...
	public function __construct($registry) {
				...
				if ( class_exists('\liveopencart\ext\poip') ) {
					$this->liveopencart_ext_poip = \liveopencart\ext\poip::getInstance($registry);
				}
	...
	public function getProducts() {
		...
		foreach ($cart_query->rows as $cart) {
            ...
            if($stock_available <= 0)
				...
				if ( $this->liveopencart_ext_poip ) {
					$product_query->row['image'] = $this->liveopencart_ext_poip->getProductCartOrderImage($product_query->row['product_id'], $option_data, $product_query->row['image']);
				}
