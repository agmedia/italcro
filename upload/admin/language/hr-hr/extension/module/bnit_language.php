<?php
$_['heading_title'] = 'BNIT - Italian Language';

$_['text_language_status_str'] = 'Language Status: ';

$_['text_language_status'][0] = 'Not Installed ';
$_['text_language_status'][1] = 'Base language version ';
$_['text_language_status'][2] = 'Full version Installed';
$_['text_language_status'][3] = 'Language detected but not installed/configured with the extension';

$_['text_title_install_full'] = 'Installa la versione completamente in italiano - Install the full Italian language';
$_['text_install_full'] = '<img src="language/en-gb/en-gb.png" /> Installs and configures the italian language for almost anything in front and backend.<br><span class="tile-warning">Not Suggested for non-italian Shops</span><br><span class="tile-success">Suggested for mainly Italian Shops</span><br><br><img src="language/it-it/it-it.png" /> Installa la versione completamente in italiano e configura la lingua italiana per frontend e backend.<br><span class="tile-success">Consigliato per negozi gestiti principalmente in Italiano</span><br><span class="tile-warning">Non consigliabile per negozi gestiti principalmente in lingue diverse dall&apos;italiano</span><br><br>';
