<?php
$_['extension_name']                    = "Product Quick Edit Plus";
...
$_['text_more_options']                 = "<strong>Note!</strong> More configuration options are available on the product list page (Catalog > Products)";
...
$_['text_catalog_products']             = "Catalog -> Products";
$_['text_catalog_products_qe']          = "Catalog -> Products (QE)";
$_['text_products_qe']                  = "Products (QE)";
$_['text_replace_old']                  = "(replaces the menu standard Products page)";
$_['text_add_as_new']                   = "(adds a new menu entry)";

// Entry
$_['entry_extension_status']            = "Extension status";
$_['entry_display_in_menu_as']          = "Display in menu as";
$_['entry_gross_price_for_actions']     = "Use gross price for actions";
...
// Help
$_['help_gross_price_for_actions']      = "Edit price values in actions (Discounts, Options, Specials) using gross price (including tax) instead of net price (without tax).";
