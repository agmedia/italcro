...
class ControllerProductManufacturer extends Controller {
	...
	public function info() {
		...
		if ($manufacturer_info) {
			...
			$data['description'] = !empty($manufacturer_info['brand_description'])? html_entity_decode($manufacturer_info['brand_description']): '';
		...
		if (strtotime($result['date_available']) > strtotime('-' . $this->config->get('newlabel_status') . ' day')) {
			...
			$is_new = false;
				...
				// << Product Option Image PRO module
				'poip_images'  => class_exists('\liveopencart\ext\poip') ? $this->liveopencart_ext_poip->getModel()->getCategoryImagesForController( $result['product_id'], isset($setting)?($setting):(false) ) : [],
				// >> Product Option Image PRO module
