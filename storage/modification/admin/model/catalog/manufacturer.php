...
class ModelCatalogManufacturer extends Model {
	public function addManufacturer($data) {
		$this->db->query("INSERT INTO " . DB_PREFIX . "manufacturer SET name = '" . $this->db->escape($data['name']) . "', meta_title = '" . $this->db->escape($data['meta_title']) . "',h1 = '" . $this->db->escape($data['h1']) . "',h2 = '" . $this->db->escape($data['h2']) . "', image_alt = '" . $this->db->escape($data['image_alt']) . "', image_title = '" . $this->db->escape($data['image_title']) . "', meta_description = '" . $this->db->escape($data['meta_description']) . "',meta_keyword = '" . $this->db->escape($data['meta_keyword']) . "', brand_description = '" . $this->db->escape($data['description']) . "', sort_order = '" . (int)$data['sort_order'] . "'");
	...
	public function editManufacturer($manufacturer_id, $data) {
		$this->db->query("UPDATE " . DB_PREFIX . "manufacturer SET name = '" . $this->db->escape($data['name']) . "', meta_title = '" . $this->db->escape($data['meta_title']) . "',h1 = '" . $this->db->escape($data['h1']) . "',h2 = '" . $this->db->escape($data['h2']) . "', image_alt = '" . $this->db->escape($data['image_alt']) . "', image_title = '" . $this->db->escape($data['image_title']) . "', meta_description = '" . $this->db->escape($data['meta_description']) . "',meta_keyword = '" . $this->db->escape($data['meta_keyword']) . "', brand_description = '" . $this->db->escape($data['description']) . "', sort_order = '" . (int)$data['sort_order'] . "' WHERE manufacturer_id = '" . (int)$manufacturer_id . "'");
