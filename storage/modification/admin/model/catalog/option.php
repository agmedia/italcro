...
class ModelCatalogOption extends Model {
			...
			$this->db->query("INSERT INTO " . DB_PREFIX . "option_description SET option_id = '" . (int)$option_id . "', language_id = '" . (int)$language_id . "', name = '" . $this->db->escape($value['name']) . "'");
				...
				if ( class_exists('\liveopencart\ext\poip') ) {
					...
					if ( isset($data['poip_settings']) ) {
						$this->liveopencart_ext_poip->getModel()->setRealOptionSettings($option_id, $data['poip_settings']);
					}
				}
				// >> Product Option Image PRO module
	...
	public function editOption($option_id, $data) {
		...
		$this->db->query("DELETE FROM " . DB_PREFIX . "option_description WHERE option_id = '" . (int)$option_id . "'");
				...
				if ( class_exists('\liveopencart\ext\poip') ) {
					liveopencart\ext\poip::getInstance($this->registry);
					$this->liveopencart_ext_poip->getModel()->deleteRealOptionSettings($option_id);
				}
				// >> Product Option Image PRO module
