	...
	protected function getForm() {
      ...
      //<-SF PRODUCTS IMAGE MANAGER
				...
				if ( class_exists('\liveopencart\ext\poip') ) {
					...
					$this->load->controller('extension/module/product_option_image_pro/addProductPageResources', $data);
					$data = $this->load->controller('extension/module/product_option_image_pro/getProductPageData', $data);
				}
				// >> Product Option Image PRO module
		...
		// Categories
				 ...
				 if (version_compare(VERSION, '2.3') >= 0) {
					$data['attachfile'] = $this->load->controller('extension/module/mmos_attachmanager/integrateproduct');
				 } else {
				 	$data['attachfile'] = $this->load->controller('module/mmos_attachmanager/integrateproduct');
				 }
		...
		foreach ($product_options as $product_option) {
			...
			if (isset($product_option['product_option_value'])) {
				...
				// << Product Option Image PRO module
				'images' => ( isset($product_option_value['images']) && class_exists('\liveopencart\ext\poip') ? $this->liveopencart_ext_poip->getModel()->addThumbsIfNeeded($product_option_value['images']) : array()),
				// >> Product Option Image PRO module
