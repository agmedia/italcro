	...
	public function index($setting) {
		...
		if (!empty($setting['product'])) {
			...
			foreach ($products as $product_id) {
				...
				// << Product Option Image PRO module
				'poip_images'  => class_exists('\liveopencart\ext\poip') ? $this->liveopencart_ext_poip->getModel()->getCategoryImagesForController( $product_info['product_id'], isset($setting)?($setting):(false) ) : [],
				// >> Product Option Image PRO module
