...
$_['text_trial_description']	= '%s jede(s/n) %d %s für %d Zahlung(en) dann';
$_['text_payment_description']	= '%s jede(s/n) %d %s für %d Zahlung(en)';
$_['text_payment_cancel']		= '%s jede(s/n) %d %s bis Beendigung';
$_['text_day']					= 'Tag(e)';
$_['text_week']					= 'Woche(n)';
...
*/
$_['text_payment_until_canceled_description'] = "%s alle %d %s(a) bis zum Abbruch";
$_['text_short_description'] = "Grundfunktionen";
$_['text_spec_description'] = "Technische Daten";
$_['text_tax_included'] = "inkl. MwSt.";
$_['text_from'] = "Von";
$_['text_jamstvo'] = "Originalgarantie 12 Monate";
$_['text_ovlasteno'] = "Autorisierte Verkaufsstelle in der Republik Kroatien";
$_['entry_captcha'] = "Geben Sie den angezeigten Code in das Feld unten ein.";
$_['error_captcha'] = "Achtung: Der eingegebene Verifizierungscode stimmt nicht mit dem auf dem Bild überein!";